...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        for(String locProviderName : locProviderList){
            txtInfo.append("Loc Provider :" + locProviderName + "\n");
            txtInfo.append("Enabled" + locManager.isProviderEnabled(locProviderName)+ "\n\n");
    ...
    private void printInfo(LocationProvider locProvider) { txtInfo.append("이름: " + locProvider.getName() + "\n");
